    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "force": {
                    "type": "boolean",
                    "description": "If true, re-import and re-analyze even if a cached project exists (default: false)",
                    "default": False
                },
                "analysis_mode": {
                    "type": "string",
                    "enum": ["default", "minimal"],
                    "description": "Analysis mode: 'default' runs all analyzers, 'minimal' skips heavy analyzers for faster import of large binaries",
                    "default": "default"
                }
            },
    ...
    try:
        ...
        if name == "analyze_binary":
            result = bridge.analyze_binary(
                ...
                analysis_mode=arguments.get("analysis_mode", "default")
            )
            ...
            result = bridge.get_disassembly(
                project_name=arguments["project_name"],
                program_name=arguments["program_name"],
                identifier=arguments["function_or_address"],
            ...
            result = bridge.rename_symbol(
                project_name=arguments["project_name"],
                program_name=arguments["program_name"],
                identifier=arguments["address_or_name"],
            ...
            result = bridge.get_data_at_address(
                ...
                program_name=arguments["program_name"],
                address=arguments["address"],
                length_or_type=arguments.get("length_or_type", "32"),
                format_type=arguments.get("format", "hex")
            )
